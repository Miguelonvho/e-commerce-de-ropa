<div class="crud-container bg-black text-white">
    ...
    <div class="d-flex justify-content-end mt-4 mx-5">
        <div class="d-flex align-items-end">
            <a href="<?= base_url('crud_productos_view') ?>" class="btn btn-secondary me-2">Volver</a>
        </div>
    </div>
    ...
    <div class="scroll-container-crud">
        ...
        <?php else: ?>
            <?php foreach ($productos as $producto): ?>
                ...
                <!-- Vista escritorio -->
                <div
                    class="producto-card d-none d-md-flex align-items-center text-center m-2 py-5 border border-secondary rounded">
                    <div class="col-1">
                        <?php if (empty($producto['imagen'])): ?>
                            <img src="<?= base_url('assets/img/Iconos/sin-imagen.png') ?>" alt="Sin imagen"
                                style="width: 100px; height: 90px; object-fit: cover;">
                        <?php else: ?>
                            <img src="<?= base_url('public/assets/uploads/' . $producto['imagen']) ?>" alt="Producto"
                                style="width: 100px; height: 90px; object-fit: cover;">
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="col-2">
                        ...
                        <a href="<?= base_url('restaurar_producto/' . $producto['id_producto']) ?>"
                            class="btn px-2 btn-warning">Activar</a>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p><strong>Precio Venta:</strong> $<?= number_format($producto['precio_venta'], 2, ',', '.') ?>
                                </p>
