<div class="crud-container bg-black text-white">
    ...
    <div class="scroll-container-crud">
        ...
        <?php foreach ($productos as $producto): ?>
            ...
            <!-- Vista escritorio -->
            <div
                class="producto-card d-none d-md-flex align-items-center text-center m-2 p-2 border border-secondary rounded">
                <div class="col-1">
                ...
                <div class="col-2">
                    <a href="<?= base_url('editar_productos_view') ?>" class="btn btn-primary mb-2">Editar</a><br>
