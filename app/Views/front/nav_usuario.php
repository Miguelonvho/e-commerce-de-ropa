...
<div class="collapse navbar-collapse" id="navbarScroll">
    <ul class="navbar-nav nav-underline my-2 my-lg-0 navbar-nav-scroll"
        ...
        <!-- Quienes somos -->
        <li class="nav-item">
            <a class="text-white nav-link" href="<?= base_url('quienes_somos') ?>">Quiénes somos</a>
        </li>
    </ul>

    <!-- Zona derecha (Usuario, Carrito, Buscador) -->
    <div class="nav-busqueda d-flex gap-4 m-2 ms-auto align-items-center">
        <!-- Usuario -->
        <div class="nav-item dropdown">
            ...
            <ul id="info-sesion" style="width: 25vw;" class="dropdown-menu bg-black my-2 p-4">
                ...
                <li class="d-flex justify-content-center gap-4 mt-3">
                    <a href="<?= base_url('plantilla_perfil') ?>" class="btn d-flex align-items-center btn-outline-light">Ver perfil</a>
                    <a href="<?= base_url('logout') ?>" class="btn d-flex align-items-center btn-outline-light">Cerrar sesión</a>
                </li>
            </ul>
        </div>
