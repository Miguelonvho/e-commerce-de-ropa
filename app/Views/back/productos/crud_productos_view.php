...
<div class="crud-container bg-black text-white d-flex flex-column" style="height: 550px">
    ...
    <div class="d-flex justify-content-end mt-3 mx-4">
        <a href="<?= base_url('alta_productos_view') ?>" class="btn btn-outline-success btn-sm me-2">Agregar</a>
        <a href="<?= base_url('productos_eliminados') ?>" class="btn btn-outline-secondary btn-sm">Eliminados</a>
    </div>
                    ...
                    <?php foreach ($productos as $producto): ?>
                        <tr>
                            ...
                            <td class="d-flex justify-content-center gap-3">
                                ...
                                <a href="<?= base_url('eliminar_producto/' . $producto['id_producto']) ?>"
    ...
    <div class="d-md-none d-flex justify-content-center overflow-auto gap-4 flex-wrap mx-3 mt-3">
        <?php if (empty($productos)): ?>
            <div class="text-center text-white p-5">No se encontraron productos.</div>
        <?php else: ?>
            <?php foreach ($productos as $producto): ?>
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="mb-2">
                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a href="<?= base_url('borrar_producto/' . $producto['id_producto']) ?>"
